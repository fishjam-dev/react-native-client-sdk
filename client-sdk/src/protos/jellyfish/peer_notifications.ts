  ...
  toJSON(message: PeerMessage): unknown {
    ...
    message.authenticated !== undefined &&
      (obj.authenticated = message.authenticated
        ? PeerMessage_Authenticated.toJSON(message.authenticated)
        : undefined);
    message.authRequest !== undefined &&
      (obj.authRequest = message.authRequest
        ? PeerMessage_AuthRequest.toJSON(message.authRequest)
        : undefined);
    message.mediaEvent !== undefined &&
      (obj.mediaEvent = message.mediaEvent
        ? PeerMessage_MediaEvent.toJSON(message.mediaEvent)
        : undefined);
    return obj;
  },
