...
export const HlsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        getHlsContent: async (roomId: string, filename: string, range?: string, hLSMsn?: number | null, hLSPart?: number | null, hLSSkip?: string | null, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const HlsApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getHlsContent(roomId: string, filename: string, range?: string, hLSMsn?: number | null, hLSPart?: number | null, hLSSkip?: string | null, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<string>> {
        ...
        async subscribeHlsTo(roomId: string, subscriptionConfig?: SubscriptionConfig, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            ...
            const index = configuration?.serverIndex ?? 0;
            const operationBasePath = operationServerMap['HlsApi.subscribeHlsTo']?.[index]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, operationBasePath || basePath);
        },
    }
};
...
export class HlsApi extends BaseAPI {
     ...
     * @memberof HlsApi
     */
    public getHlsContent(roomId: string, filename: string, range?: string, hLSMsn?: number | null, hLSPart?: number | null, hLSSkip?: string | null, options?: AxiosRequestConfig) {
